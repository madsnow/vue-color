<template>
    <div id="app">
        <a class="github-fork-ribbon" href="https://github.com/xiaokaike/vue-color" title="Fork me on GitHub">Fork me on
            GitHub</a>
        <div class="header-container">
            ...
            <div class="header">
                <div class="intro-wrap">
                    <div class="intro">
                        <h1>Vue-color</h1>
                        <p role="presentation">A Collection of Color Pickers from Sketch, Photoshop, Chrome, Github,
                            Twitter, Material Design & more</p>
                    </div>
                </div>
                <div class="demo-item">
        ...
        <div class="demo-container">
            ...
            <div class="demo-list">
                <div class="demo-item">
                    <light-picker :value="colors" @input="updateValue"></light-picker>
                    <h2>Light</h2>
                </div>
            </div>
        </div>
